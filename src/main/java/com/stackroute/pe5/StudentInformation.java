    ...
    //Printing the array in sorted manner
     class Main{
        ...
        public static void main(String[] args) {
            ...
            listofstudents.add(new StudentInformation("12", "Sai", 20));
            listofstudents.add(new StudentInformation("17", "Ram", 25));
            listofstudents.add(new StudentInformation("15", "Sai", 24));
            listofstudents.add(new StudentInformation("19", "Ravi", 23));
            listofstudents.add(new StudentInformation("10", "Raj", 29));
